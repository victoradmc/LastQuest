...
export class EquipmentComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.weapons = [
      { name: 'Cajado (2H)(A)', cost: '100z', accuracy: 'VONT + VONT', damage: 'MR + 6', img: 'staff'},
      { name: 'Grimório (2H)(A)', cost: '100z', accuracy: 'INT + INT', damage: 'MR + 6', img: 'tome'},
      { name: 'Besta (2H)', cost: '150z', accuracy: 'DES + INT', damage: 'MR + 8', img: 'crossbow'},
      ...
      { name: 'Soqueira (1H)', cost: '150z', accuracy: 'DES + FOR', damage: 'MR + 6', img: 'knuckle'},
      { name: 'Adaga (1H)', cost: '150z', accuracy: 'DES + INT', damage: 'MR + 4', img: 'dagger'},
      { name: 'Pistola (1H)(M)', cost: '250z', accuracy: ' DEX + INT', damage: 'MR + 8', img: 'pistol'},
      ...
      { name: 'Machado (1H)(M)', cost: '250z', accuracy: 'FOR + FOR', damage: 'MR + 10', img: 'axe'},
      { name: 'Machado de Guerra (2H)(M)', cost: '350z', accuracy: 'FOR + FOR', damage: 'MR + 14', img: 'waraxe'},
      { name: 'Lança (1H)(M)', cost: '200z', accuracy: 'DES + FOR', damage: 'MR + 8', img: 'spear'},
      { name: 'Alabarda (2H)(M)', cost: '250z', accuracy: 'DES + FOR', damage: 'MR + 8', img: 'alabard'},
      { name: 'Espada bastarda (1H)', cost: '200z', accuracy: 'DES + FOR + 1', damage: 'MR + 6', img: 'sword'},
      { name: 'Espada de duas mãos (2H)(M)', cost: '250z', accuracy: 'DES + FOR + 1', damage: 'MR + 10', img: 'greatsword'},
      { name: 'Katana (2H)(M)', cost: '200z', accuracy: 'DES + INT + 1', damage: 'MR + 10', img: 'katana'},
      { name: 'Rapieira (1H)(M)', cost: '200z', accuracy: 'DES + INT + 1', damage: 'MR + 6', img: 'rapier'},
      { name: 'Improvisado (1H)', cost: '0z', accuracy: 'DES + FOR', damage: 'MR + 2', img: 'improvised'},
